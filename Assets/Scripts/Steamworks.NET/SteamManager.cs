...
#if (!(UNITY_STANDALONE_WIN || UNITY_STANDALONE_LINUX || UNITY_STANDALONE_OSX || STEAMWORKS_WIN || STEAMWORKS_LIN_OSX)) || DISABLE_STEAM
...
public class SteamManager : MonoBehaviour {
	...
	protected virtual void Awake() {
		...
		try {
			...
			if (SteamAPI.RestartAppIfNecessary((AppId_t)2229450)) {
